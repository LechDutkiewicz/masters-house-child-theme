...
<a href="<?php the_permalink(); ?>" class="flat button <?php echo $button_color = bon_get_option( 'cta_button_color', 'emerald' ); ?> radius cta expand" title="<?php the_title(); ?>"><span class="cta-headline"><?php _e( 'Read more', 'bon' ); ?></span></a>
