			...
			<div class="modal-body">
				<form action="" method="post" id="contact-requestform" class="modal-form">
					...
					<div>
						...
						<input class="flat button <?php echo bon_get_option( 'cta_button_color', 'emerald' ); ?> radius" name="submit" type="submit" id="submit" tabindex="5" value="<?php _e( 'Send', 'bon' ) ?>" <?php the_ga_event( "Contact", "Click Send", "Contact Form" ); ?>/>
