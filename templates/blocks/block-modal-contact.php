		...
		<form action="" method="post" id="contact-requestform" class="modal-form">
			...
			<fieldset>
				...
				<div>
					...
					<button class="flat button <?php echo bon_get_option( 'cta_button_color', 'emerald' ); ?> radius submit" id="submit" <?php the_ga_event( "Contact", "Click Send", "Contact Form", shandora_get_meta( $post->ID, 'listing_price') ); ?>><?php _e( 'Send', 'bon' ) ?></button>
