				...
				<form action="" method="post" id="customize-requestform" class="modal-form">
					...
					<div class="row collapse textarea-container input-container" data-match-height>
						<div class='column large-12 small-11 input-container-inner pencil'>
							<textarea name="messages" class="attached-input required" id="messages" cols="58" rows="10" placeholder="<?php _e( "In case you want to ask us about something, type it here. You can also leave it empty and we'll contact you soon.", 'bon' ); ?>"  tabindex="4"></textarea>
