...
// get global agent ID to render him separately
    ...
    <div id="body-container" class="container">
        ...
        <div class="single-page-container">
            ...
            <section class="row entry-content">
               <div class="column large-12">
                <ul class="bon-toolkit-accordion" id="accordion-main-agent">
                    ...
                    <li class="accordion-group">
                        <input type="radio" name="toggle-section-main-agent" id="toggle-target-<?php echo $wp_query->current_post; ?>"<?php if ( $wp_query->current_post == 0 ) echo ' checked'; ?>>
                        <label for="toggle-target-<?php echo $wp_query->current_post; ?>" class="accordion-section-title">
                            <span class="like-h3"><?php the_title(); ?></span>
                            ...
                            <div class="agent-profile<?php echo has_post_thumbnail() ? ' has-img' : ''; ?>">
                                ...
                                <div class="profile-header center">
                                    <?php if ( current_theme_supports( 'get-the-image' ) ) {
                                        $thumbnail = get_the_image( array( 'size' => 'agent_small', 'link_to_post' => false, 'before' => '<figure class="agent-image">', 'after' => '</figure>' ) );
                                    } ?>
                                </div>
                                <?php } ?>
                                <div class="profile-content">                        
                                    <?php if ( $job = shandora_get_meta( $post->ID, 'agentjob' ) ) { ?>
                                    <p class="like-h3"><?php echo $job; ?></p>
                                    <?php } ?>
                                    <ul class="bi-ul">
                                        <?php if ( $area ) { ?>
        ...
        <section class="row entry-content">
            <header class="column large-12">
                <h3><?php _e( 'Regional', 'bon' ); ?> <?php _e( 'representatives', 'bon' ); ?></h3>
                <hr>
            </header>
            <div class="column large-12">
